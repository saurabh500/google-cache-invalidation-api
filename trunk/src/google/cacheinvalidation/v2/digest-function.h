...
#ifndef GOOGLE_CACHEINVALIDATION_V2_DIGEST_FUNCTION_H_
#define GOOGLE_CACHEINVALIDATION_V2_DIGEST_FUNCTION_H_
...
#endif  // GOOGLE_CACHEINVALIDATION_V2_DIGEST_FUNCTION_H_
