...
#ifndef GOOGLE_CACHEINVALIDATION_V2_TEST_TEST_UTILS_H_
#define GOOGLE_CACHEINVALIDATION_V2_TEST_TEST_UTILS_H_
...
#endif  // GOOGLE_CACHEINVALIDATION_V2_TEST_TEST_UTILS_H_
