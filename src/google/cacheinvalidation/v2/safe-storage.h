...
#ifndef GOOGLE_CACHEINVALIDATION_V2_SAFE_STORAGE_H_
#define GOOGLE_CACHEINVALIDATION_V2_SAFE_STORAGE_H_
...
class SafeStorage : public Storage {
 public:
  ...
  virtual void DeleteKey(const string& key, Callback1<bool>* done);
...
#endif  // GOOGLE_CACHEINVALIDATION_V2_SAFE_STORAGE_H_
