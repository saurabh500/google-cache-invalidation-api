...
#ifndef GOOGLE_CACHEINVALIDATION_V2_RECURRING_TASK_H_
#define GOOGLE_CACHEINVALIDATION_V2_RECURRING_TASK_H_
...
#endif  // GOOGLE_CACHEINVALIDATION_V2_RECURRING_TASK_H_
